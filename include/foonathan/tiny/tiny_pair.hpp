...
namespace tiny
{
    namespace detail
    {
        ...
        using tiny_pair_impl_storage_t = tiny_pair_impl_storage<TinyBits <= spare_bits<Big>(), Big,
    ...
    public:
        ...
        /// \requires It must be a tuple of two types where the first one is convertible to `T` and
        /// the second to `bool`.
